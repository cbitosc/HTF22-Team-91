...
import Navbar from "../pages/Mentor/Navbar";
...
export default function Mentor(props) {
  ...
  const navigation = [
    ...
    { name: 'Student Activities', href: './activities', current: props.activities },
  ...
  return (
    <>
      <div className="min-h-full">
        ...
        <div className="component min-h-screen">{props.mentorComponent}</div>
      </div>
    </>
  );
}
