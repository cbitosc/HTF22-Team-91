...
//   const [selectedFile, setSelectedFile] = useState("");
  ...
  const SuccessContainer = () => {
    return (
      <Alert color="success">
        <span>
          <span className="font-medium">Success! User Updated Successfully. <a className=" font-semibold text-teal-700" href="/login">please login again</a></span> {msg}
        </span>
      </Alert>
    );
  };
          ...
          <div className="flex justify-center px-4 py-6 sm:px-0">
            <div className=" w-full md:w-4/5 lg:w-3/5 m-4 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
              <div className="flex flex-col items-center p-10">
                ...
                <span className="text-sm text-gray-500 dark:text-gray-400">
                  {user.batch_year}st year, {user.branch}-{user.section}
                </span>
